				...
				<table width="98%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td colspan="2" valign="top"><span class="left_bt">感谢您使用
								商家信息网 网站管理系统程序</span><br> <br> <span class="left_txt">&nbsp;<img
								src="<%=basePath%>images/ts.gif" width="16" height="16">
								提示：<br>
							...
							<table width="100%" height="144" border="0" cellpadding="0"
								...
								<tr>
									<td width="7%" height="27"
										background="<%=basePath%>images/news-title-bg.gif"><img
										src="<%=basePath%>images/news-title-bg.gif" width="2"
										height="27">
									</td>
									<td width="93%"
										background="<%=basePath%>images/news-title-bg.gif"
												...
												<TBODY>
													...
													<TR>
														<TD width="4%" height="28"
															background="<%=basePath%>images/news-title-bg.gif"></TD>
														<TD height="25" colspan="2"
															background="<%=basePath%>images/news-title-bg.gif"
															class="left_txt">亲爱的管理员： <font color="#FFFFFF"
															class="left_ts"><b></b>
														</TD>
													</TR>
													<TR>
											...
											<TABLE width=98% border=0 align="center" cellPadding=0
												...
												<TBODY>
													...
													<TR>
														...
														<TD height="25" colspan="2"
															background="<%=basePath%>images/news-title-bg.gif"
															class="left_txt"><span class="TableRow2">服务器IP:</span>系统版本：</TD>
													</TR>
													<TR>
													...
													<TR>
														...
														<TD height="25" bgcolor="#FAFBFC"><span
															class="left_txt">FSO文本读写：</span><span class="TableRow2"><font
																color="#FF0066"><b><img
																		src="<%=basePath%>images/X.gif" width="12" height="13">
																</b>
															</font><img src="<%=basePath%>images/g.gif" width="12"
																height="12">
														</span>
														</TD>
														<TD height="25" bgcolor="#FAFBFC"><span
															class="left_txt">数据库使用：</span><span class="left_ts"><img
																src="<%=basePath%>images/X.gif" width="12" height="13"><b
												...
												<TBODY>
													...
													<TR>
														...
														<TD bgcolor="#FAFBFC" class="left_txt"><span
															class="left_ts">1、</span>本程序由www.mycodes.net全新改造(QQ:215288671)
														</TD>
													...
													<TR>
														<TD bgcolor="#FAFBFC">&nbsp;</TD>
														<TD bgcolor="#FAFBFC" class="left_txt"><span
															class="left_ts">4、</span>程序使用，技术支持请联系www.mycodes.net。</TD>
														<TD bgcolor="#FAFBFC" class="left_txt">&nbsp;</TD>
													</TR>
													<TR>
														<TD height="5" colspan="3"></TD>
...
四、界面设计精美，后台功能强大。傻瓜式后台操作，无需专业的网站制作知识，只要会打字，就会管理维护网站。</textarea> </label>
					...
					<tr>
						...
						<td width="51%" class="left_txt"><img
							src="<%=basePath%>images/icon-mail2.gif" width="16" height="11">
							客户服务邮箱：215288671@qq.com<br> <img
							src="<%=basePath%>images/icon-phone.gif" width="17" height="14">
							官方网站：http://www.mycodes.net</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
				</table>
			</td>
			<td background="<%=basePath%>images/mail_rightbg.gif">&nbsp;</td>
		</tr>
		<tr>
