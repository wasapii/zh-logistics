...
<title>商品分类信息新增界面</title>
<link href="images/skin.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<%=basePath%>js/jquery-1.9.1.min.js"></script>

</head>
<body>
<form id="addCategory" name="addCategory" method="post" action="categoryAction!addCategory.action">
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：商品分类信息新增</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="32%" height="30" bgcolor="#f2f2f2"><input name="category.categoryCode" type="text" size="30"/></td>
              </tr>
              <tr>
                <td height="30" align="right" class="left_txt2">商品分类名称：</td>
                <td>&nbsp;</td>
                <td height="30"><input type="text" name="category.categoryName" size="30" /></td>
              </tr>
              <tr>
                <td height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">上级商品分类编号：</td>
                <td bgcolor="#f2f2f2">&nbsp;</td>
                <td height="30" bgcolor="#f2f2f2"><input type="text" name="category.parentCode" size="30" /></td>
              </tr>
              <tr>
