...
<body>
<form id="addGoods" name="addGoods" method="post" action="goodsAction!addGoods.action">
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：商品信息新增</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
 			<tr>
                ...
                <td width="32%" height="30" bgcolor="#f2f2f2"><input name="goods.goodsCode" type="text" size="30" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="30" bgcolor="#f2f2f2"><input type="text" name="goods.goodsName" size="30" /></td>
              </tr>
              <tr>
                <td height="30" align="right" class="left_txt2">条码： </td>
                <td>&nbsp;</td>
                <td height="30"><input type="text" name="goods.barCode" size="30" /></td>
              </tr>
              <tr>
                <td height="30" align="right" bgcolor="#F7F8F9" class="left_txt2">单位：</td>
                <td bgcolor="#F7F8F9">&nbsp;</td>
                <td height="30" bgcolor="#F7F8F9"><input type="text" name="goods.unit" size="30" /></td>
              </tr>
              <tr>
                <td height="30" align="right" class="left_txt2">商品规格： </td>
                <td>&nbsp;</td>
                <td height="30"><input type="text" name="goods.specifications" size="30" /></td>
              </tr>
              <tr>
              <tr>
                <td height="30" align="right" class="left_txt2">备注： </td>
                <td>&nbsp;</td>
                <td height="30"><input type="text" name="goods.memo" size="30" /></td>
              </tr>
              <tr>
