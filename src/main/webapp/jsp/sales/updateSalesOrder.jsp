...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
	    <tr>
	       <td height="31"><div class="titlebt">销售出库单详细信息</div></td><td align="right"><button id="deleteTableRow">删除一行</button></td>
	    </tr>
    </table></td>
  ...
  <tr>
	...
	<form name="updateSalesOrder" method="post" action="salesOrderAction!updateSalesOrder.action">
    ...
    <table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：销售出库单修改</td>
          </tr>
          <tr>
          ...
          <tr><td>
              ...
              <tr>
                <td width="20%" height="30" align="left" bgcolor="#f2f2f2" class="left_txt2">销售出库单详情设置：</td>
              </tr>
			  <tr>
