...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="935" height="29" valign="top" background="images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">销售出库单详细信息</div></td>
  ...
  <tr>
	...
	<form id="addSalesOrder" name="addSalesOrder" method="post" action="salesOrderAction!addSalesOrder.action">
    <table width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="left_txt">当前位置：发货出库单新增</td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="20%" height="30" align="left" class="left_txt2">发货出库单详情设置：</td>
          </tr>
          <tr><td>
